<template>
  <main>
    <div
      class="main-content font-semibold tracking-wide sm:uppercase h-64 sm:h-56 flex flex-col justify-center items-center text-center overflow-auto lg:w-2/3 lg:mx-auto"
    >
